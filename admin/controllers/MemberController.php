...
class MemberController extends AdminBaseController
{
	...
	public function addAction()
	{
		...
		$this->oView->link_url = site_url('member/add');
		$this->oView->cancel_url = site_url('member/list');
	...
	public function editAction($member_id)
	{
		...
		$this->oView->link_url = site_url('member/edit/'.$member_id);
		$this->oView->cancel_url = site_url('member/list');
