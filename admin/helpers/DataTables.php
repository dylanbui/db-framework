...
//  https://legacy.datatables.net/examples/data_sources/server_side.html
    ...
    public static function loadDataWithOption($object, $aColumns, $defaultSort = null)
	{
//        $aColumns = array( 'user_id', 'username', 'full_name', 'email', 'mobile', 'active', 'user_id');
        ...
        return DataTables::convertRowsetToOutputData($rowSets, $totalRecord, $aColumns);
    ...
    // -- $object co the truyen vao la 1 callback function --
    public static function convertRowsetToOutputData($rowSets, $totalRecord, $aColumns, $sEcho = null)
    {
        if (is_null($sEcho))
            $sEcho = intval($_GET['sEcho']);
